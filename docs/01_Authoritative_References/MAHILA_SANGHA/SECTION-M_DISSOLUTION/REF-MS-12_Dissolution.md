# REF-MS-12 — Dissolution

**Document Family:** REF-MS

**Document ID:** REF-MS-12

**Title:** Dissolution

**Repository Path:**
`docs/01_Authoritative_References/MAHILA_SANGHA/SECTION-M_DISSOLUTION/`
...
- Dissolution (Bye-law, Clause 12)
- Final certification block (President, Parichalak, Secretary)
...
REF-MS-12 is an Authoritative Reference document. It preserves the official Mahila Sangha Bye-Law without introducing ERP interpretation, implementation guidance, or business rules.
...
Sd/- Surabala Devi — President

Sd/- Durgacharan Mohanty — Parichalak
...
REF-MS-MOA (cross-referenced "Article 3 of the memorandum")
...
Confirmed the Dissolution clause's cross-reference is to the Memorandum's Article 3 (REF-MS-MOA), not the Bye-law's own fuller "Aims and objects" clause (REF-MS-1) — these are two distinct provisions in the source, following the same pattern already identified and preserved in the NSS Bye-Law's own Objects-of-the-Society structure (see REF-001-004 / REF-001-004-B).
