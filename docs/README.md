...
| `03_Solution/` | 19 module design docs (`modules/`), `architecture/`, `standards/`, `infrastructure/`, `database/` (cross-module conventions), `security/` (architecture map), `ui/` (13 mockups); `api/` deferred to DDL phase |
