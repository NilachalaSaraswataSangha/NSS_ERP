...
3. **Final decision authority for governance decisions recorded in the GDR rests with the NSS Governing Body** — the constitutional governing body of NSS (REF-003-002) — exercised through its President (REF-003-004) and/or Parichalak (REF-003-009), not the Governance Authority/Project Steering Committee. A new rule, `GOV-ROLE-006 — Final Decision Authority`, is added to GOV-001 §6 to state this.
