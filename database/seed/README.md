...
| `01_foundation/` | **Implemented** — 8 files: master categories (11), master data values (58, across GENDER/MARITAL_STATUS/ADDRESS_TYPE/DOCUMENT_TYPE/MEMBERSHIP_TYPE/MEMBERSHIP_STATUS/RELATIONSHIP_TYPE), `id_sequence_master` rows (9, `PERSON` padded to 10 digits), country (5), state (112), district (~770, India only), system settings (4), postal codes |
